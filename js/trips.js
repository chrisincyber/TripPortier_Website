...
class TripsManager {
  ...
  async searchDestinations(query) {
    ...
    const popularDestinations = [
      ...
      // Spanish Islands
      { name: 'Ibiza', country: 'Spain', code: 'ES', lat: 38.9067, lng: 1.4206 },
      { name: 'Mallorca', country: 'Spain', code: 'ES', lat: 39.6953, lng: 3.0176 },
      { name: 'Palma de Mallorca', country: 'Spain', code: 'ES', lat: 39.5696, lng: 2.6502 },
      { name: 'Menorca', country: 'Spain', code: 'ES', lat: 39.9496, lng: 4.1104 },
      { name: 'Tenerife', country: 'Spain', code: 'ES', lat: 28.2916, lng: -16.6291 },
      { name: 'Gran Canaria', country: 'Spain', code: 'ES', lat: 27.9202, lng: -15.5474 },
      { name: 'Lanzarote', country: 'Spain', code: 'ES', lat: 29.0469, lng: -13.5899 },
      { name: 'Fuerteventura', country: 'Spain', code: 'ES', lat: 28.3587, lng: -14.0537 },
      { name: 'Formentera', country: 'Spain', code: 'ES', lat: 38.7057, lng: 1.4368 },
      { name: 'Madrid', country: 'Spain', code: 'ES', lat: 40.4168, lng: -3.7038 },
      { name: 'Malaga', country: 'Spain', code: 'ES', lat: 36.7213, lng: -4.4214 },
      { name: 'Marbella', country: 'Spain', code: 'ES', lat: 36.5099, lng: -4.8862 },
      { name: 'Seville', country: 'Spain', code: 'ES', lat: 37.3891, lng: -5.9845 },
      { name: 'Valencia', country: 'Spain', code: 'ES', lat: 39.4699, lng: -0.3763 },
      { name: 'Bilbao', country: 'Spain', code: 'ES', lat: 43.2630, lng: -2.9350 },
      // Additional popular destinations
      { name: 'Phuket', country: 'Thailand', code: 'TH', lat: 7.8804, lng: 98.3923 },
      { name: 'Chiang Mai', country: 'Thailand', code: 'TH', lat: 18.7883, lng: 98.9853 },
      ...
      { name: 'Kuala Lumpur', country: 'Malaysia', code: 'MY', lat: 3.1390, lng: 101.6869 },
      { name: 'Dublin', country: 'Ireland', code: 'IE', lat: 53.3498, lng: -6.2603 },
      { name: 'Edinburgh', country: 'United Kingdom', code: 'GB', lat: 55.9533, lng: -3.1883 },
      ...
      { name: 'Budapest', country: 'Hungary', code: 'HU', lat: 47.4979, lng: 19.0402 },
      { name: 'Dubrovnik', country: 'Croatia', code: 'HR', lat: 42.6507, lng: 18.0944 },
      { name: 'Split', country: 'Croatia', code: 'HR', lat: 43.5081, lng: 16.4402 },
      { name: 'Krakow', country: 'Poland', code: 'PL', lat: 50.0647, lng: 19.9450 },
      { name: 'Tel Aviv', country: 'Israel', code: 'IL', lat: 32.0853, lng: 34.7818 },
      { name: 'Petra', country: 'Jordan', code: 'JO', lat: 30.3285, lng: 35.4444 },
      ...
      { name: 'Cusco', country: 'Peru', code: 'PE', lat: -13.5320, lng: -71.9675 },
    ];
